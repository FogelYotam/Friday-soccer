...
- **דירוג כוח** (`eloForm`) = ELO משוקלל לפי **חודשים**: ממוצע ה-ELO בכל חודש בשנה האחרונה, במשקלים **12·11·…·1** מהחודש האחרון לישן. מי שלא שיחק ב-**90 הימים האחרונים לא מדורג כלל** (`ELO_FORM_ACTIVE_DAYS`).
